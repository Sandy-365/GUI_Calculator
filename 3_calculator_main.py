...
if __name__ == "__main__":
    ...
    label=Label(master=frame0,text="",font="calibari 16",height=3,bg='white')
    label.pack(fil=BOTH,side='right')

    frame1=Frame(master=sandeep,bg="red",height=20,width=20)
    frame1.pack(fill=BOTH,expand=True)
 
    buttonclr=Button(master=frame1,text="clr",font="calibari 20 bold",width=400,height=200,bg='white',fg='black',command=lambda:clr())
    buttonclr.grid(row=0,column=0)   

    frameb=Frame(master=frame1)
    frameb.grid(row=0,column=1)
    buttonlb=Button(master=frameb,text="(",font="calibari 20 bold",width=50,height=10,bg='white',fg='black',command=lambda:getnum("("))
    buttonlb.grid(row=0,column=0)   
    buttonrb=Button(master=frameb,text=")",font="calibari 20 bold",width=50,height=10,bg='white',fg='black',command=lambda:getnum(")"))
    ...
    buttonpow=Button(master=frame1,text="^",font="calibari 20 bold",width=400,height=200,bg='white',fg='black',command=lambda:getsym("^"))
    buttonpow.grid(row=0,column=3)    

    buttonmod=Button(master=frame1,text="%",font="calibari 20 bold",width=400,height=200,bg='white',fg='black',command=lambda:getsym("%"))
